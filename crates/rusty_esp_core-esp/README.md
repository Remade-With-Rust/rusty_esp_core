...
The chip backends for [`rusty_esp_core`](https://crates.io/crates/rusty_esp_core): the
...
Part of Janus (Remade With Rust). Plan: `docs/plans/rusty_esp_core.md` in the repo.
